...
insert into chart_cfg values (QMS_SEQ.nextval, '’€œﬂÕº≈‰÷√', 'LINE_CFG', '{  chart: {  renderTo: ''lineContainer'' },  legend: {  layout: ''vertical'', align: ''right'', verticalAlign: ''middle'', borderWidth: 0 } }');
commit;
