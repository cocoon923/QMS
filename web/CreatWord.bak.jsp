...
<%
   //记得不要不屏蔽
     response.setHeader( "Content-Disposition", "attachment;filename="  + new String( sWordName.replaceAll("/","&").getBytes("gb2312"), "ISO8859-1" ) );
...
12.0pt;font-family:黑体;mso-ascii-font-family:&quot;Century Gothic&quot;;color:black">
 ...
 mso-fareast-font-family:黑体;color:black">3.0.0</span></b></span><span style="mso-bookmark:_Toc52455870"><b><span lang="EN-US" style="font-size:24.0pt;
mso-bidi-font-size:12.0pt;font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;;mso-fareast-font-family:
...
<%
  ...
  ORI_DEMAND_INFO=ORI_DEMAND_INFO.replaceAll(" ","&nbsp;").replaceAll("\n","<br>");
...
<%
  if(REMARK6!=null)
  REMARK6=REMARK6.replaceAll(" ","&nbsp;").replaceAll("\n","<br>");  
    out.print(REMARK6);
%>
</span></p>
...
<%
  ...
  DEMAND_SOLUTION=DEMAND_SOLUTION.replaceAll(" ","&nbsp;").replaceAll("\n","<br>");  
...
<%
  ...
  DEMAND_CHG_INFO=DEMAND_CHG_INFO.replaceAll(" ","&nbsp;").replaceAll("\n","<br>");  
...
<span style="font-size:9.0pt;line-height:150%;font-family:宋体;mso-ascii-font-family:Verdana;color:green">
 <%
      if(REMARK1!=null)
      {
	     ...
	     REMARK1=REMARK1.replaceAll(" ","&nbsp;").replaceAll("\n","<br>");
	     out.print(REMARK1);
	  }
 %>
</span></p>
...
<%
	if(REMARK2!=null)
	{
	   ...
	   REMARK2=REMARK2.replaceAll(" ","&nbsp;").replaceAll("\n","<br>");
	   out.print(REMARK2);
	}
%>
</span></p>
...
<%
      if(REMARK3!=null)
	  {
	     ...
	     REMARK3=REMARK3.replaceAll(" ","&nbsp;").replaceAll("\n","<br>");
	     out.print(REMARK3);
	  }
%>
</span></p>
...
<%
      if(REMARK4!=null)
      {
	     ...
	     REMARK4=REMARK4.replaceAll(" ","&nbsp;").replaceAll("\n","<br>");
	     out.print(REMARK4);
	  }
%>
</span></p>
...
<%
      if(REMARK5!=null)
      {
	     ...
	     REMARK5=REMARK5.replaceAll(" ","&nbsp;").replaceAll("\n","<br>");
	     out.print(REMARK5);
	  }
%>
</span></p>	
...
<%
       ...
       Vector vModuleName=dataBean.getModuleNameInfo1(sSubRMId,iRMId,sSubSysId);
	   int ik=0;
       for(int i=vModuleName.size()-1;i>=0;i--)
       {
          //out.print("i="+i);
		  ...
		  //String modulestr="100339,102567,104409,103780,103048,103738,104293,102978,102996,103069,102450,102911,102676,103004,105191,102350,102550,103892,104240,105267,102443,102822,103238,103077,104113,103781,102977,103152,102897,102403,102866,104267";
		  //if(modulestr.indexOf(sModuleId)>0)
		  //continue;
		  ik++;
		  //out.print("<br>sName="+sName+";<br>sModuleId="+sModuleId);
%>
...
<span style="mso-list:Ignore">7.2.<%=(ik)%><span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;&nbsp;</span></span></span><![endif]>
<span lang="EN-US">CASE<%=(ik)%>-</span>
...
<%
	...
	Vector vCaseAllInfo=dataBean.getModuleCaseInfo1(sSubRMId,iRMId,sModuleId,sSubSysId);
	//out.print("<sSubRMId>sSubRMId="+sSubRMId+"<br>sModuleId="+sModuleId+"<br>vCaseAllInfo.size()="+vCaseAllInfo.size());
	int k=0;
		 ...
		 %>
			...
			<%
				...
				if(!ACCESSORY.equals(""))   //输出附件
				{
                    ...
                    url1=url1.substring(0,url1.indexOf("CreatWord"));
			%>
			<span lang="EN-US" style="font-size:9.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-fareast-font-family:  Arial;mso-font-kerning:0pt">
