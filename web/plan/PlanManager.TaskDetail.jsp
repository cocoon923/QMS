...
/* 				             	if(stype.equals("1")) //需求
				             ...
				             <td class="<%if(i%2!=0) out.print("coltext");else out.print("coltext2"); %>" name="DEMAND_SRC_ID" style="color:#ff0000;">&nbsp;<%=sDEMAND_SRC_ID%></td>
				             <td class="<%if(i%2!=0) out.print("coltext");else out.print("coltext2"); %>" name="TASK_TITLE" style="color:#ff0000;">&nbsp;<%=sTASK_TITLE%></td>
				             <td class="<%if(i%2!=0) out.print("coltext");else out.print("coltext2"); %>" name="PROJ_NAME" style="color:#ff0000;">&nbsp;<%=sPROJ_NAME%></td>
				             <td class="<%if(i%2!=0) out.print("coltext");else out.print("coltext2"); %>" name="MODULE_NAME" style="color:#ff0000;">&nbsp;<%=sMODULE_NAME%></td>
				             <td class="<%if(i%2!=0) out.print("coltext");else out.print("coltext2"); %>" name="TASK_STATUS" style="color:#ff0000;">&nbsp;<%=sTASK_STATUS%></td>
				             <td class="<%if(i%2!=0) out.print("coltext");else out.print("coltext2"); %>" name="TESTER_NAME" style="color:#ff0000;">&nbsp;<%=sTESTER_NAME%></td>
				            <!-- 
				             ...
				             <td class="<%if(i%2!=0) out.print("coltext");else out.print("coltext2"); %>" name="COMMIT_TIME" style="color:#ff0000;">&nbsp;<%=sCOMMIT_TIME%></td>
				         </tr>  
			 <%	
			 	}
			 	else
			 ...
			 %>
				        ...
				        <tr> 
				             ...
				             %>"  target="_blank"><%=sTASK_ID%></a></td>
				             <td class="<%if(i%2!=0) out.print("coltext");else out.print("coltext2"); %>" name="DEMAND_SRC_ID" >&nbsp;<%=sDEMAND_SRC_ID%></td>
				             <td class="<%if(i%2!=0) out.print("coltext");else out.print("coltext2"); %>" name="TASK_TITLE" >&nbsp;<%=sTASK_TITLE%></td>
				             <td class="<%if(i%2!=0) out.print("coltext");else out.print("coltext2"); %>" name="PROJ_NAME">&nbsp;<%=sPROJ_NAME%></td>
				             <td class="<%if(i%2!=0) out.print("coltext");else out.print("coltext2"); %>" name="MODULE_NAME">&nbsp;<%=sMODULE_NAME%></td>
				             <td class="<%if(i%2!=0) out.print("coltext");else out.print("coltext2"); %>" name="TASK_STATUS">&nbsp;<%=sTASK_STATUS%></td>
				             <td class="<%if(i%2!=0) out.print("coltext");else out.print("coltext2"); %>" name="TESTER_NAME">&nbsp;<%=sTESTER_NAME%></td>
				            <!-- 
				             <td class="<%if(i%2!=0) out.print("coltext");else out.print("coltext2"); %>" name="GROUP_NAME" style="color:#ff0000;">&nbsp;<%if(sGROUP_NAME==null) out.print("");else out.print(sGROUP_NAME);%></td>
				              -->
				             <td class="<%if(i%2!=0) out.print("coltext");else out.print("coltext2"); %>" name="DEV_NAME">&nbsp;<%=sDEV_NAME%></td>
				             <td class="<%if(i%2!=0) out.print("coltext");else out.print("coltext2"); %>" name="COMMIT_TIME">&nbsp;<%=sCOMMIT_TIME%></td>
