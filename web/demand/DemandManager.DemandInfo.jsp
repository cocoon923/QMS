          ...
          <tr>
            <td class="contentbottomline"><table width="100%" border="0" cellspacing="0" cellpadding="1">
                ...
                <tr  class="contentbg">
                  ...
                  <td class="pagetextdetails">
                  <input name="demandTitle" type="text" class="inputstyle" id="demandTitle"  size="50" value="<%=demandTitle%>"></td>
                </tr>
	          ...
	          <td class="contentbottomline"><div align="left"> 
	              <table width="146" border="0" cellspacing="5" cellpadding="5">
	                <tr> 
	                  ...
	                  <td width="101"><table width="80" border="0" cellspacing="1" cellpadding="1">
	                      <tr> 
	                        <td class="buttonstyle" onMouseOver = "changecolor(this)" onMouseOut = "restorcolor(this)" type="submit" name="B1" onclick="toExport(/*href*/'DemandManager.DemandInfoExportExcel.jsp?QueryStartTime=<%=QueryStartTime%>&QueryEndTime=<%=QueryEndTime%>&QueryProduct=<%=QueryProduct%>&QueryReq=<%=QueryReq%>&QueryGu=<%=QueryGu%>&sNewRid=<%=sNewRid%>&sNewGid=<%=sNewGid%>')">导出EXCEL<br></td>
	                  ...
	                  <td width="101"><table width="100" border="0" cellspacing="1" cellpadding="1">
	                      <tr> 
	                        <td class="buttonstyle" onMouseOver = "changecolor(this)" onMouseOut = "restorcolor(this)" type="submit" name="B4" onclick="Update_GoToUrl(/*href*/'../task/TaskManager.NewTask.jsp?iCheckDate=1')">生成任务单<br></td>
	                      </tr>
	                    </table></td>
	                    
	                  <td width="101"><table width="100" border="0" cellspacing="1" cellpadding="1">
	                      <tr> 
	                        <td class="buttonstyle" onMouseOver = "changecolor(this)" onMouseOut = "restorcolor(this)" type="submit" name="B5" onclick="Update_GoToUrl(/*href*/'DemandManager.ModifyDemand.jsp?iCheckDate=1')">需求补录<br></td>
	                      </tr>
	                    </table></td>
					<!-- 
	                  <td width="101"><table width="80" border="0" cellspacing="1" cellpadding="1">
	                    ...
	                    <td width="101"><table width="80" border="0" cellspacing="1" cellpadding="1">
	                      <tr> 
	                        <td class="buttonstyle" onMouseOver = "changecolor(this)" onMouseOut = "restorcolor(this)" type="submit" name="B6" onclick="trackRequest();">需求追踪<br></td>
	                      </tr>
	                    </table></td>
	                </tr>
	              </table>
             		...
             		for(int i=0;i<vDemandRequest.size();i++)
			    		{
			    			...
			    			<tr>
			    				<td class="coltext"><div align="center"><input type="radio" name="demandradio" value="<%out.print(sDEMAND_ID+"|"+sDemandStatus);%>"></div></td>
				             	<td class="coltext">(<%=j%>)</td>
				             	<td class="coltext" ><a href="#"  onclick="goToURL(/*href*/'DemandManager.DemandInfo.jsp?planid=<%=sDEMAND_ID%>')"><%=sDEMAND_ID%></a></td>
				             	<td class="coltext" ><%=sDemandName%></td>
				             	<td class="coltext" ><%=sDemandStatus%></td>
				             	<td class="coltext" ><%=sSubSysName%></td>
				             	<td class="coltext" ><%=sModuleName%></td>
				             	<td class="coltext" ><%=sProjectName%></td>
				             	<td class="coltext" ><%=sLevelId%></td>
				             	<td class="coltext" ><%=sPlanDevBeginTime%></td>
				             	<td class="coltext"><%=sPlanDevTime%></td>
				             	<td class="coltext"><%=sDevId%></td>
				             	<td class="coltext"><%=sTesterId%></td>
