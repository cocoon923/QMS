...
function statInfo(url)
{
	...
	//获取统计开始时间
	if(document.StatPerformanceQA.chk_start_date.checked==true)
	{
		starttime = document.getElementById('repstarttime').value;
	}
	//获取统计结束时间
	if(document.StatPerformanceQA.chk_end_date.checked==true)
	{
...
<form name="StatPerformanceQA" method="post">
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
  <td class="buttonstyle" onMouseOver = "changecolor(this)" onMouseOut = "restorcolor(this)" onclick="statInfo(/*href*/'Stat.Performance.QA.jsp?sOper=1')">统 计</td>
  </tr>
  </table></td>
  </tr></table></div></td></tr>
...
%>
  ...
  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr class="title" style= "height: 30px; "> 
  <td>测试人员处理任务单完成所需平均时间（只统计测试完成的任务单，包含：开发、测试过程）:<br></td>
  <td width="24"> <div align="right"><br></div></td>
  </tr>
  </table></td>
  </tr>
