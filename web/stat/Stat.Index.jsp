                            ...
                            <tr>
                                <td class="contentbottomline">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="1">
                                        <tr class="contentbg">
                                            <td width="15%" class="pagetitle1">
                                                <div align="center"><input type="radio" name="radio" value="1"></div>
                                            </td>
                                            <td width="85%" class="pagetextdetails"><a href="Stat.DevTestTime.jsp">统计需求开发、测试时间</a>
                                            </td>
                                        </tr>

                                        <tr class="contentbg1" style="display: none;">
                                            <td width="15%" class="pagetitle1">
                                                <div align="center"><input type="radio" name="radio" value="2"></div>
                                            </td>
                                            <td width="85%" class="pagetextdetails"><a
                                                    href="Stat.DepartmentWork.jsp?GroupType=0">CRM/PRM统计本部门完成工作（含：需求、bug、故障）</a>
                                            </td>
                                        </tr>

                                        <tr class="contentbg" style="display: none;">
                                            <td width="15%" class="pagetitle1">
                                                <div align="center"><input type="radio" name="radio" value="3"></div>
                                            </td>
                                            <td width="85%" class="pagetextdetails"><a
                                                    href="Stat.DepartmentWork.jsp?GroupType=1">网厅统计本部门完成工作（含：需求、bug、故障）</a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="contentbg1">
                                            <td width="15%" class="pagetitle1">
                                                <div align="center"><input type="radio" name="radio" value="4"></div>
                                            </td>
                                            <td width="85%" class="pagetextdetails"><a
                                                    href="Stat.DepartmentWorkForDev.jsp">统计开发部门工作量</a></td>
                                        </tr>
                                                            ...
                                                            <table width="80" border="0" cellspacing="1"
                                                                ...
                                                                <tr>
                                                                    <td class="buttonstyle"
                                                                        ...
                                                                        onMouseOut="restorcolor(this)" onclick="next()">
                                                                        下一步
                                                                    </td>
                                                                </tr>
                                                            </table>
                            ...
                            <tr>
                                <td class="contentbottomline">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="1">
                                        ...
                                        <tr class="contentbg">
                                            <td width="15%" class="pagetitle1">
                                                <div align="center"><input type="radio" name="statdefradio"
                                                                           value="<%=sStatId%>"></div>
                                            </td>
                                            <td width="85%" class="pagetextdetails"><a
                                                    href="Stat.Interface.jsp?statid=<%=sStatId%>&wherefiled=index"><%=sStatCN %>
                                            </a></td>
                                        </tr>
                                        <%
                                            }
                                                        ...
                                                        <td width="101">
                                                            <table width="80" border="0" cellspacing="1"
                                                                ...
                                                                <tr>
                                                                    <td class="buttonstyle"
                                                                        onMouseOver="changecolor(this)"
                                                                        onMouseOut="restorcolor(this)"
                                                                        onclick="goToURL(/*href*/'Stat.Interface.jsp?wherefiled=index')">
                                                                        下一步
                                                                    </td>
                                                                </tr>
                                                            </table>
                            ...
                            <tr>
                                <td class="contentbottomline">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="1">
                                        <tr class="contentbg">
                                            <td width="15%" class="pagetitle1">
                                                <div align="center"><input type="radio" name="radio" value="5"></div>
                                            </td>
                                            <td width="85%" class="pagetextdetails"><a
                                                    href="Stat.Performance.Index.jsp">各部门绩效考评数据</a></td>
                                        </tr>
