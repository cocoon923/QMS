...
<%
    ...
    String sRMId_old=request.getParameter("requirement_old");
    if(sRMId_old==null) sRMId_old="";
	//String sRMId="R20030";
	int iRMId=0;
	...
	//qcs上一下else中逻辑被屏蔽，因为上传class文件未重启未生效，为了不影响其他文档的生成，先屏蔽以下逻辑。
	else //处理针对没有写case的文档生成word时文档名称的处理。取需求对应任务单的人员名称。
	{
		Vector aAuthorInfo1=dataBean.getDemandAuthorInfo(sSubRMId,iRMId);
		if(aAuthorInfo1.size()>0)
		{
		   for(int i1=aAuthorInfo1.size()-1;i1>=0;i1--)
		   {
		       HashMap hash1 = (HashMap) aAuthorInfo1.get(i1);
	           sTemp = (String) hash1.get("OP_NAME");  //获取中文名
			   sTemp1 = (String) hash1.get("OP_LOGIN");  //获取登陆名
			   sTemp2=(String) hash1.get("OP_ID");
			   if(i1==(aAuthorInfo1.size()-1))
			   {
			     sAuthorName=sTemp;
				 sAuthorName1=sTemp1;
			   }
	...
	String sWordName="";
	String sWordDate="";
	Vector aWordName=new Vector();
	if(!sRMId_old.equals(""))
	{
		int iRMId_old=0;
		String sSubRMId_old=sRMId_old.substring(1);
    	iRMId_old=sRMId_old.indexOf("R");
    	if(iRMId_old>=0)
			iRMId_old=1;
		else
			iRMId_old=2; 
		aWordName=dataBean.getWordName(sSubRMId_old,iRMId_old);
	}
	else
	{
		aWordName=dataBean.getWordName(sSubRMId,iRMId);
	}
	if(aWordName.size()>0)
	{
...
<%
   //记得不要不屏蔽
     response.setHeader( "Content-Disposition", "attachment;filename="  + new String( sWordName.replaceAll("/","&").replaceAll(":","：").getBytes("gb2312"), "ISO8859-1" ) );
...
<div class="Section1" style="layout-grid:15.6pt">
	...
	<a name="_Toc52455870"><span lang="EN-US" style="color:black">&nbsp;</span></a></p>
	<p class="MsoNormal" align="center" style="text-align:center">
	<span style="mso-bookmark:_Toc52455870">
	<span lang="EN-US" style="color:black">&nbsp;</span></span></p>
	<p class="MsoNormal" align="center" style="text-align:center">
	<span style="mso-bookmark:_Toc52455870">
	<span lang="EN-US" style="color:black">&nbsp;</span></span></p>
	<p class="MsoNormal" align="center" style="text-align:center">
...
mso-fareast-font-family:黑体;color:black"></span></span></p>
	<p class="MsoNormal" align="center" style="text-align:center">
...
mso-bidi-font-size:12.0pt;font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;;mso-fareast-font-family:
黑体;color:black"></span></span></p>
	<p class="MsoNormal" align="center" style="text-align:center">
	<span style="mso-bookmark:_Toc52455870"><b>
	<span style="font-size:24.0pt;mso-bidi-font-size:
12.0pt;font-family:黑体;mso-ascii-font-family:&quot;Century Gothic&quot;;color:black">
	版本：</span></b></span><span style="mso-bookmark:_Toc52455870"><b><span lang="EN-US" style="font-size:24.0pt;
 mso-bidi-font-size:12.0pt;font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;;
 mso-fareast-font-family:黑体;color:black">NGBOSS1.0</span></b></span><span style="mso-bookmark:_Toc52455870"><b><span lang="EN-US" style="font-size:24.0pt;
mso-bidi-font-size:12.0pt;font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;;mso-fareast-font-family:
黑体;color:black"></span></b></span></p>
	<p class="MsoNormal" align="center" style="text-align:center">
	<span style="mso-bookmark:_Toc52455870">
	<span lang="EN-US" style="color:black">&nbsp;</span></span></p>
	<p class="MsoNormal" align="center" style="text-align:center">
...
mso-bidi-font-size:12.0pt;mso-fareast-font-family:楷体_GB2312;mso-no-proof:yes">
	&nbsp;</span></span></p>
	<p class="MsoNormal" align="center" style="text-align:center">
	<span style="mso-bookmark:_Toc52455870">
	<span lang="EN-US" style="font-size:10.0pt;
mso-bidi-font-size:12.0pt;mso-fareast-font-family:楷体_GB2312;mso-no-proof:yes">
 ...
 .5pt solid windowtext;mso-border-insidev:.5pt solid windowtext">
  ...
  12.0pt;font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;;mso-fareast-font-family:
  楷体_GB2312"> <span lang="EN-US"></span></span></span></p>
			</td>
  ...
  mso-bidi-font-size:12.0pt;font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;;
  mso-fareast-font-family:楷体_GB2312"></span></span></p>
			</td>
  ...
  solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:16.7pt">
   ...
   &quot;Century Gothic&quot;,&quot;sans-serif&quot;;mso-fareast-font-family:楷体_GB2312">
			<%=sAuthorDate%></span><span lang="EN-US" style="font-size:10.0pt;
  mso-bidi-font-size:12.0pt;font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;;
  mso-fareast-font-family:楷体_GB2312"></span></span></p>
			</td>
		</tr>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:17.55pt">
			...
			<span lang="EN-US" style="font-size:10.0pt;
  mso-bidi-font-size:12.0pt;font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;;
  mso-fareast-font-family:楷体_GB2312">V3.0</span></span></p>
			</td>
		</tr>
...
&quot;Times New Roman&quot;;mso-hansi-font-family:&quot;Times New Roman&quot;">
	亚信科技（中国）有限公司版权所有</span><span lang="EN-US"></span></b></span></p>
	<p class="MsoNormal" align="center" style="margin-top:12.0pt;text-align:center;
mso-pagination:widow-orphan"><span style="mso-bookmark:_Toc52455870">
...
line-height:150%;color:black"></span></b></span></p>
<table class="MsoNormalTable" border="1" cellspacing="0" cellpadding="0" width="804" style="border: medium none ; margin-left: 78.35pt; border-collapse: collapse;" height="183">
  ...
  &quot;Times New Roman&quot;">日期</span><span lang="EN-US" style="font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;"></span></b></span></p>
		</td>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:22.4pt">
		...
		<b style="mso-bidi-font-weight:normal">
		<span style="font-family:宋体;mso-ascii-font-family:&quot;Century Gothic&quot;;mso-hansi-font-family:
  &quot;Times New Roman&quot;">修订号</span><span lang="EN-US" style="font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;"></span></b></span></p>
		</td>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:22.4pt">
		...
		<b style="mso-bidi-font-weight:normal">
		<span style="font-family:宋体;mso-ascii-font-family:&quot;Century Gothic&quot;;mso-hansi-font-family:
  &quot;Times New Roman&quot;">描述</span><span lang="EN-US" style="font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;"></span></b></span></p>
		</td>
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:22.4pt">
		...
		<b style="mso-bidi-font-weight:normal">
		<span style="font-family:宋体;mso-ascii-font-family:&quot;Century Gothic&quot;;mso-hansi-font-family:
  &quot;Times New Roman&quot;">著者</span><span lang="EN-US" style="font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;"></span></b></span></p>
		</td>
	</tr>
	<%
  ...
  padding:0cm 5.4pt 0cm 5.4pt;height:24.45pt">
		...
		<%=arrAuthorDate.get(i)%></span><span lang="EN-US" style="font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;"><br /></span></span></p>
		</td>
  ...
  &quot;Century Gothic&quot;">
	 <%  
		...
		{ 
			out.print("修改测试文档"); 
		}%></span><span lang="EN-US" style="font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;"><br /></span></span></p>
		</td>
  ...
  &quot;Century Gothic&quot;;mso-hansi-font-family:&quot;Century Gothic&quot;">
		<%=arrAuthorInfo.get(i)%></span><span lang="EN-US" style="font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;"><br /></span></span></p>
		</td>
	</tr>
	<%
		}
...
<span style="font-family:宋体;mso-ascii-font-family:&quot;Times New Roman&quot;;mso-hansi-font-family:
&quot;Times New Roman&quot;;color:black">引言</span></a><span lang="EN-US" style="color:black"></span></span></h1>
...
&quot;Times New Roman&quot;;color:black">编写目的</span></a></span><span lang="EN-US" style="color:black"></span></h2>
...
&quot;Times New Roman&quot;;color:black">顺利地进行测试和确认而编写。</span><span lang="EN-US" style="font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;;color:black"></span></p>
<p class="MsoNormal" style="text-indent:1.0cm;mso-char-indent-count:2.7">
<span style="font-family:宋体;mso-ascii-font-family:&quot;Century Gothic&quot;;mso-hansi-font-family:
...
&quot;Times New Roman&quot;;color:black">营帐系统项目管理人员、技术负责人、软件开发人员、软件测试人员、局方测试人员。</span><span lang="EN-US" style="font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;"></span></p>
<h2 style="margin-top:1.0pt;margin-right:0cm;margin-bottom:1.0pt;margin-left:
...
<span style="font-family:黑体;mso-ascii-font-family:
&quot;Times New Roman&quot;;color:black">背景</span></span></a><span lang="EN-US" style="color:black"></span></h2>
...
_Toc52455873"><span style="mso-bookmark:_Toc91473626"><span lang="EN-US" style="font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;"></span></span></span></p>
<p class="MsoNormal" style="margin-left:21.0pt">
<span style="mso-bookmark:_Toc52455873"><span style="mso-bookmark:_Toc91473626">
<b>
<span style="font-family:宋体;mso-ascii-font-family:
...
宋体;mso-ascii-font-family:&quot;Century Gothic&quot;;mso-hansi-font-family:&quot;Times New Roman&quot;">
移动通信责任有限公司</span></span></span><span style="mso-bookmark:_Toc52455873"><span style="mso-bookmark:_Toc91473626"><span lang="EN-US" style="font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;"></span></span></span></p>
...
</span>AIOPENBOSS</span></span></span><a name="_Toc91473627"></a><span style="mso-bookmark:_Toc91473627"><span lang="EN-US" style="font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;"></span></span></p>
...
mso-bidi-font-weight:bold"></span></span></h1>
<h2 style="margin-top:1.0pt;margin-right:0cm;margin-bottom:1.0pt;margin-left:
...
&quot;Times New Roman&quot;;color:black">：</span><span lang="EN-US" style="color:black"></span></span></h2>
...
font-family:宋体;mso-ascii-font-family:&quot;Century Gothic&quot;;mso-hansi-font-family:
&quot;Times New Roman&quot;;color:black">，内存</span></span><span style="mso-bookmark:_Toc91473627"><span lang="EN-US" style="mso-bidi-font-size:10.5pt;font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;;
 color:black">256m</span></span><span style="mso-bookmark:_Toc91473627"><span style="mso-bidi-font-size:10.5pt;font-family:宋体;mso-ascii-font-family:&quot;Century Gothic&quot;;
mso-hansi-font-family:&quot;Times New Roman&quot;;color:black">以上，若干台</span><span lang="EN-US" style="mso-bidi-font-size:
10.5pt;font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;;color:black"></span></span></p>
<p class="MsoNormalIndent"><span style="mso-bookmark:_Toc91473627">
<span style="mso-bidi-font-size:10.5pt;font-family:宋体;mso-ascii-font-family:&quot;Century Gothic&quot;;
...
<table class="MsoNormalTable" border="1" cellspacing="0" cellpadding="0" width="697" style="width:523.0pt;margin-left:40.4pt;border-collapse:collapse;border:none;
 ...
 mso-border-insideh:.5pt solid windowtext;mso-border-insidev:.5pt solid windowtext">
  ...
  &quot;Century Gothic&quot;,&quot;sans-serif&quot;;color:black"></span></span></p>
		</td>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:19.85pt">
		<p class="MsoNormalIndent"><span style="mso-bookmark:_Toc91473627">
		<span lang="EN-US" style="mso-bidi-font-size:10.5pt;font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;;
  color:black">ORACLE 9.i</span></span></p>
		</td>
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:19.85pt">
		<p class="MsoNormalIndent"><span style="mso-bookmark:_Toc91473627">
		<span lang="EN-US" style="mso-bidi-font-size:10.5pt;font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;;
  color:black">HP UNIX</span></span></p>
		</td>
		<td width="276" valign="top" style="width:207.0pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt;height:19.85pt">
		<p class="MsoNormalIndent"><span style="mso-bookmark:_Toc91473627">
		<span lang="EN-US" style="mso-bidi-font-size:10.5pt;font-family:&quot;Century Gothic&quot;,&quot;sans-serif&quot;;
  color:black">BEA TUXEDO 8.0</span></span></p>
		</td>
		<td width="276" valign="top" style="width:207.0pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
...
<span lang="EN-US" style="mso-bidi-font-size:22.0pt;line-height:150%;font-family:宋体;mso-bidi-font-family:宋体;color:black;mso-bidi-font-weight:bold">
<span style="mso-list:Ignore">3<span style="font:7.0pt &quot;Times New Roman&quot;">&nbsp;&nbsp;
</span></span></span><![endif]>
<span style="mso-bidi-font-size:22.0pt;
line-height:150%;font-family:宋体;color:black;mso-bidi-font-weight:bold">原始需求<span lang="EN-US"></span></span></span></h1>

<p class="MsoNormalleft"><span style="mso-bookmark:_Toc91473627">
<%
  if(ORI_DEMAND_INFO!=null)
  ORI_DEMAND_INFO=ORI_DEMAND_INFO.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll(" ","&nbsp;").replaceAll("\n","<br>");
...
<span style="mso-bidi-font-size:22.0pt;line-height:150%;font-family:宋体;color:black;mso-bidi-font-weight:bold">测试分析<span lang="EN-US"></span></span></span></h1>

<p class="MsoNormalleft"><span style="mso-bookmark:_Toc91473627">
<%
  if(REMARK6!=null)
  REMARK6=REMARK6.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll(" ","&nbsp;").replaceAll("\n","<br>");  
    out.print(REMARK6);
%>
</span></p>
...
<span style="mso-bidi-font-size:22.0pt;line-height:150%;font-family:宋体;color:black;mso-bidi-font-weight:bold">解决方案<span lang="EN-US"></span></span></span></h1>

<p class="MsoNormalleft"><span style="mso-bookmark:_Toc91473627">
<%
  if(DEMAND_SOLUTION!=null)
  DEMAND_SOLUTION=DEMAND_SOLUTION.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll(" ","&nbsp;").replaceAll("\n","<br>");  
...
<span style="mso-bidi-font-size:22.0pt;line-height:150%;font-family:宋体;color:black;mso-bidi-font-weight:bold">变更确认信息<span lang="EN-US"></span></span></span></h1>

<p class="MsoNormalleft"><span style="mso-bookmark:_Toc91473627">
<%
  if(DEMAND_CHG_INFO!=null)
  DEMAND_CHG_INFO=DEMAND_CHG_INFO.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll(" ","&nbsp;").replaceAll("\n","<br>");  
...
<span style="mso-bidi-font-size:22.0pt;line-height:150%;font-family:宋体;color:black;mso-bidi-font-weight:bold">测试确认<span lang="EN-US"></span></span></span></h1>
...
<span style="font-family:黑体;mso-ascii-font-family:&quot;Times New Roman&quot;;color:black;mso-bidi-font-weight:bold">注意事项</span><span lang="EN-US" style="color:black;mso-bidi-font-weight:bold"></span></h2>
...
<p class="MsoNormalleft" style="margin-top:0cm;margin-right:84.0pt;margin-bottom:0cm;margin-left:51pt;margin-bottom:.0001pt;mso-para-margin-top:0cm;mso-para-margin-right:8.0gd;mso-para-margin-bottom:0cm;mso-para-margin-left:51pt;mso-para-margin-bottom:.0001pt;line-height:150%">
<span style="font-size:9.0pt;line-height:150%;font-family:宋体;mso-ascii-font-family:Verdana;color:green">
 <%
      if(REMARK1!=null)
      {
	     ...
	     REMARK1=REMARK1.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll(" ","&nbsp;").replaceAll("\n","<br>");
	     out.print(REMARK1);
	  }
 %>
</span></p>
...
<%
	if(REMARK2!=null)
	{
	   ...
	   REMARK2=REMARK2.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll(" ","&nbsp;").replaceAll("\n","<br>");
	   out.print(REMARK2);
	}
%>
</span></p>
...
<p class="MsoNormalleft" style="margin-top:0cm;margin-right:84.0pt;margin-bottom:0cm;margin-left:51pt;margin-bottom:.0001pt;mso-para-margin-top:0cm;mso-para-margin-right:8.0gd;mso-para-margin-bottom:0cm;mso-para-margin-left:51pt;mso-para-margin-bottom:.0001pt;text-indent:0cm;line-height:150%;mso-list:l11 level1 lfo3;tab-stops:list 99.75pt 117.75pt">
<span style="font-size:9.0pt;line-height:150%;font-family:宋体;mso-ascii-font-family:Verdana;color:green">
<%
      if(REMARK3!=null)
	  {
	     ...
	     REMARK3=REMARK3.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll(" ","&nbsp;").replaceAll("\n","<br>");
	     out.print(REMARK3);
	  }
%>
</span></p>
...
<%
      if(REMARK4!=null)
      {
	     ...
	     REMARK4=REMARK4.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll(" ","&nbsp;").replaceAll("\n","<br>");
	     out.print(REMARK4);
	  }
%>
</span></p>
...
<%
      if(REMARK5!=null)
      {
	     ...
	     REMARK5=REMARK5.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll(" ","&nbsp;").replaceAll("\n","<br>");
	     out.print(REMARK5);
	  }
%>
</span></p>	
...
<%
	//获取某个模块的所有CASE
	//out.print("<br>sSubRMId="+sSubRMId);
	//out.print("<br>iRMId="+iRMId);
	//out.print("<br>sModuleId="+sModuleId);
	Vector vCaseAllInfo=dataBean.getModuleCaseInfo(sSubRMId,iRMId,"");
	int k=0;
	int i=0;
	if(vCaseAllInfo.size()>0)
	{
		for(int j=vCaseAllInfo.size()-1;j>=0;j--)
        {
			...
			String MODULE_NAME=(String ) map1.get("MODULE_NAME");
...
<span style="font-family:宋体;mso-ascii-font-family:&quot;Times New Roman&quot;;mso-hansi-font-family:&quot;Times New Roman&quot;"><% if(MODULE_NAME!=null) out.print(MODULE_NAME);%></span></h3>
...
<div align="center">
	<table class="MsoNormalTable" border="0" cellspacing="0" cellpadding="0" width="832" style="margin-left:-31.4pt;border-collapse:collapse;mso-table-layout-alt:fixed; mso-padding-alt:0cm 5.4pt 0cm 5.4pt">
		<tr style="mso-yfti-irow:0;mso-yfti-firstrow:yes;height:26.25pt">
			...
			<span style="font-size:9.0pt;font-family:宋体;mso-ascii-font-family:Arial;mso-hansi-font-family:Arial;mso-bidi-font-family:Arial;color:black;mso-font-kerning:0pt">测试验证步骤</span><span lang="EN-US" style="font-size:9.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;color:black;mso-font-kerning:0pt"></span></b></p>
			</td>
		</tr>
		<tr style="mso-yfti-irow:2;mso-yfti-lastrow:yes;height:15.15pt">
			...
			<span style="font-size:9.0pt;font-family:宋体;mso-ascii-font-family:Arial;mso-hansi-font-family:Arial;mso-bidi-font-family:Arial"><br>测试案例<%out.print(k+"&nbsp;("+CASE_ID+")&nbsp;:&nbsp;"); %></span></b>
			<span style="font-size:9.0pt;line-height:150%;font-family:宋体;mso-ascii-font-family:Verdana;color:green">			
			<% 
				CASE_NAME=CASE_NAME.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>"); 
				out.print(CASE_NAME);%></p>
			...
			<span style="font-size:9.0pt;line-height:150%;font-family:宋体;mso-ascii-font-family:Verdana;color:green">
			<% 
				CASE_DESC=CASE_DESC.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>"); 
				out.print(CASE_DESC);%></span></p>
			...
			<span style="font-size:9.0pt;line-height:150%;font-family:宋体;mso-ascii-font-family:Verdana;color:green">
			<% 
				EXP_RESULT=EXP_RESULT.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>"); 
				out.print(EXP_RESULT);%></span></p>
			...
			<%
				CASE_ENV=CASE_ENV.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
				out.print(CASE_ENV); 
			%>
			</span></p>
			<%
			...
			<%
					CLI_INFO_ID_NAME=CLI_INFO_ID_NAME.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>");
			...
			<%
					SVR_INFO_ID_NAME=SVR_INFO_ID_NAME.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>");
			...
			<% 
					PROGRAM_NAME=PROGRAM_NAME.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>"); 
			...
			<p class="MsoNormalleft"><span style="font-size:9.0pt;line-height:150%;font-family:宋体;mso-ascii-font-family:Verdana;color:green">
			<%
				CASE_DATA_PREPARE=CASE_DATA_PREPARE.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>");
			...
			<p class="MsoNormalleft"><b style="mso-bidi-font-weight:normal">
			<span style="font-size:9.0pt;font-family:宋体;mso-ascii-font-family:Arial;mso-hansi-font-family:  Arial;mso-bidi-font-family:Arial;mso-font-kerning:0pt;color:black">测试步骤及验证：</span><span lang="EN-US" style="font-size:9.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-font-kerning:0pt"></span></b></p>
			<%
			     //获取一个case下所有的步骤
			...
			<span style="font-size:9.0pt;line-height:150%;font-family:宋体;mso-ascii-font-family:Verdana;color:black"><b style="mso-bidi-font-weight:normal">
			<%
				PROCESS_DESC=PROCESS_DESC.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>");
				out.print(m1+"."+"步骤描述：</b>&nbsp;&nbsp;"+PROCESS_DESC);
			...
			<%
					STEP_EXP_RESULT=STEP_EXP_RESULT.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>");
			...
			<%
					REAL_RESULT=REAL_RESULT.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>");
			...
			<%
					IN_DUMP=IN_DUMP.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>");
			...
			<%
					OUT_DUMP=OUT_DUMP.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>");
			...
			<%
					CASE_DATA_CHECK=CASE_DATA_CHECK.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>");
			...
			<%
					CASE_LOG=CASE_LOG.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>");
			...
			<% 
				CASE_CONCLUSION=CASE_CONCLUSION.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("\n","<br>"); 
				out.print(CASE_CONCLUSION);%></span><span lang="EN-US" style="font-size:9.0pt;  font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;color:#993366;mso-font-kerning:0pt"></span></b></p>
			
			<p class="MsoNormalleft">
			<span lang="EN-US" style="font-size:9.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;; color:black;mso-font-kerning:0pt"> 
			------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</span></p>
			<p class="MsoNormalleft"></p>
			</td>
		</tr>
...
<p class="MsoNormalleft"><span lang="EN-US">&nbsp;</span></p>
